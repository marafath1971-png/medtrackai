              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _TypewriterText(
                      text: _scanSteps[_scanStep].toUpperCase(),
...
class _ResultModalState extends State<_ResultModal> {
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  if (widget.result.identified && !widget.result.systemBusy)
                    _buildAiVerifiedBanner(L)
                        .animate()
                        .fadeIn(duration: 600.ms)
                        .slideY(begin: 0.2, end: 0, curve: Curves.easeOutQuart),
  ...
  Widget _buildAiVerifiedBanner(AppThemeColors L) {
    return Container(
      margin: const EdgeInsets.only(bottom: 24),
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [
            L.green.withValues(alpha: 0.12),
            L.green.withValues(alpha: 0.02),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color: L.green.withValues(alpha: 0.2), width: 1.0),
        boxShadow: [
          BoxShadow(
            color: L.green.withValues(alpha: 0.05),
            blurRadius: 20,
            spreadRadius: -2,
          )
        ],
      ...
      child: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(10),
            decoration: BoxDecoration(
              color: L.green.withValues(alpha: 0.12),
              shape: BoxShape.circle,
            ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text("Verify detected details below.",
                    style: AppTypography.bodySmall
                        .copyWith(color: L.text.withValues(alpha: 0.7), fontWeight: FontWeight.w600)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildToggleBtn(
    ...
    return BouncingButton(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? L.text : L.card,
          borderRadius: BorderRadius.circular(12),
          boxShadow: active ? null : L.shadowSoft,
          border: Border.all(
            color: active ? Colors.transparent : L.border.withValues(alpha: 0.08),
            width: 0.5,
          ),
        ),
        child: Text(
...
class _BentoMetricTileState extends State<_BentoMetricTile> {
  ...
  Widget build(BuildContext context) {
    ...
    ).animate().fadeIn(delay: widget.delayMs.ms, duration: 500.ms).slideY(begin: 0.1, end: 0, curve: Curves.easeOutQuart);
  }
}
...
class _ExpandableInputCard extends StatefulWidget {
  final String title;
  final IconData icon;
  ...
  @override
  State<_ExpandableInputCard> createState() => _ExpandableInputCardState();
}

class _ExpandableInputCardState extends State<_ExpandableInputCard> {
  bool _isFocused = false;

  @override
  Widget build(BuildContext context) {
    if (widget.controller.text.isEmpty && widget.title != "Personal Notes" && widget.title != "Storage") {
      return const SizedBox();
    }

    final bool isDangerous = widget.title == "Side Effects" ||
        widget.title == "Warnings" ||
        widget.title == "Interactions";

    final Color baseColor = isDangerous ? Colors.redAccent : (widget.accentColor ?? widget.L.primary);
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    size: 22, 
                    color: baseColor,
                  ).animate(onPlay: (c) => isDangerous ? c.repeat(reverse: true) : null)
            ...
            AnimatedContainer(
              ...
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
                color: widget.L.fill.withValues(alpha: 0.55),
                borderRadius: BorderRadius.circular(24),
                border: Border.all(
                  color: _isFocused
                      ? baseColor.withValues(alpha: 0.3)
                      : widget.L.border.withValues(alpha: 0.08),
              ...
              child: TextField(
                ...
                maxLines: null,
                style: AppTypography.bodyMedium.copyWith(
                  color: widget.L.text.withValues(alpha: 0.95),
                  height: 1.6,
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: AppTypography.bodySmall
                      .copyWith(color: widget.L.sub.withValues(alpha: 0.4)),
                  border: InputBorder.none,
                  isDense: true,
                  contentPadding: EdgeInsets.zero,
                ),
    ...
    ).animate().fadeIn(delay: widget.delayMs.ms, duration: 600.ms).slideY(begin: 0.1, end: 0, curve: Curves.easeOutQuart);
  }
}
