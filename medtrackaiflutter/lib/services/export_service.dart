...
class ExportService {
  ...
  static Future<void> _generateAndSharePdf({
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Container(
              ...
              child: pw.Text(
                'Disclaimer: This report is automatically generated by MedTrack AI based on user-entered data. It is intended to assist in personal health management and should not be used as a substitute for professional medical advice, diagnosis, or treatment.',
    ...
    await Share.shareXFiles([XFile(file.path)], text: 'MedTrack AI Clinical Report - $userName');
  }
